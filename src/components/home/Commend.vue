<template>
    <div class="app-commend">
        ...
        <Cell :cell="cell" />
        <!-- 手机楼层 -->
        <div class="commend-floor">
            <div><img v-if="imglist[0]" :src="imglist[0].imgbig" alt=""></div>
            <div>
                <div><img v-if="imglist[0]" :src="imglist[0].img" alt=""></div>
                <div><img v-if="imglist[0]" :src="imglist[1].img" alt=""></div>
            </div>
        </div>
        <h3>超值推荐</h3>
        <div>
